...
const contacts = [
    ...
    { name: "Antonia", number: "71 9 9533-6423" },
    { name: "Fernando", number: "71 9 9533-6423" },
    { name: "Antonio", number: "71 9 9533-6423" },
...
button.addEventListener("click", () => {
    ...
    let result = null;
    for (const nm of contacts) {
        if (contacts[nm].name.toLowerCase() === searchName) {
            result = contacts[nm];
        }
    }
